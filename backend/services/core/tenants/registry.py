...
DIRECT = [
    ...
    'education_library.LibrarySettings',
    'education_library.Book',
    'education_library.BookCopy',
    'education_library.Member',
    'education_library.Loan',
    'education_library.Reservation',
    'education_transport.Vehicle',
    'education_transport.TransportStaff',
    'education_transport.Route',
    'education_transport.Stop',
    'education_transport.Rider',
    'education_transport.Trip',
    'education_transport.TripEvent',
    'education_inventory.Category',
    'education_inventory.Supplier',
    'education_inventory.Item',
    'education_inventory.Movement',
    'education_inventory.PurchaseOrder',
    'education_inventory.PurchaseLine',
    'education_cafeteria.CafeteriaSettings',
    'education_cafeteria.FoodItem',
    'education_cafeteria.MenuDay',
    'education_cafeteria.MealPlan',
    'education_cafeteria.MealPlanMember',
...
THROUGH_PARENT = {
    ...
    'education_communication.ConversationParticipant': 'conversation__tenant',
