      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xl font-mono text-sm">{dashboardData?.teacher_id}</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {dashboardData?.classes?.map((cls) => (
              <div key={cls.id} className="p-4 border rounded-lg">
                ...
                <p className="text-sm mt-2">Students: {cls.student_count}</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex gap-3 flex-wrap">
            <Button className="bg-green-600">📅 Mark Attendance</Button>
            <Button className="bg-blue-600">📝 Enter Marks</Button>
            <Button className="bg-purple-600">📊 View Reports</Button>
          </div>
        </CardContent>
      </Card>
    </div>
