...
const curriculumService = {
  getSyllabi: () => api.get<Syllabus[] | { results: Syllabus[] }>('/auth/academics/syllabi/'),
  ...
  getSyllabusUnits: () => api.get<SyllabusUnit[] | { results: SyllabusUnit[] }>('/auth/academics/syllabus-units/'),
  ...
  getSyllabusTopics: () => api.get<SyllabusTopic[] | { results: SyllabusTopic[] }>('/auth/academics/syllabus-topics/'),
  ...
  getSyllabusSubTopics: () => api.get<SyllabusSubTopic[] | { results: SyllabusSubTopic[] }>('/auth/academics/syllabus-subtopics/'),
  ...
  getLearningResources: () => api.get<LearningResource[] | { results: LearningResource[] }>('/auth/academics/learning-resources/'),
