...
export const feesTabs: ModuleTab[] = [
  { id: 'fee-items', path: '/education/fees/fee-items', label: 'Items', icon: Receipt, dark: 'bg-emerald-700', light: 'bg-emerald-100', rgb: '4 120 87' },
  { id: 'fee-plan', path: '/education/fees/fee-plan', label: 'Plan', icon: Receipt, dark: 'bg-purple-700', light: 'bg-purple-100', rgb: '126 34 206' },
  { id: 'discount', path: '/education/fees/discount', label: 'Discount', icon: Tag, dark: 'bg-amber-700', light: 'bg-amber-100', rgb: '180 83 9' },
  { id: 'fee-accounts', path: '/education/fees/fee-accounts', label: 'Accounts', icon: Landmark, dark: 'bg-teal-700', light: 'bg-teal-100', rgb: '15 118 110' },
  { id: 'generate-invoices', path: '/education/fees/generate-invoices', label: 'Generate', icon: Receipt, dark: 'bg-indigo-700', light: 'bg-indigo-100', rgb: '67 56 202' },
  ...
  { id: 'collect-fees', path: '/education/fees/collect-fees', label: 'Collect', icon: CreditCard, dark: 'bg-rose-700', light: 'bg-rose-100', rgb: '190 24 93' },
  { id: 'fees-paid-slip', path: '/education/fees/fees-paid-slip', label: 'Slip', icon: Printer, dark: 'bg-cyan-700', light: 'bg-cyan-100', rgb: '14 116 144' },
  { id: 'fees-defaulters', path: '/education/fees/fees-defaulters', label: 'Defaulters', icon: AlertTriangle, dark: 'bg-orange-700', light: 'bg-orange-100', rgb: '194 65 12' },
  { id: 'fees-report', path: '/education/fees/report', label: 'Report', icon: BarChart3, dark: 'bg-slate-700', light: 'bg-slate-100', rgb: '51 65 85' },
];
...
export const salaryTabs: ModuleTab[] = [
  ...
  { id: 'pay', path: '/education/salary/pay', label: 'Pay Salary', icon: Wallet, dark: 'bg-emerald-700', light: 'bg-emerald-100', rgb: '4 120 87' },
  { id: 'slips', path: '/education/salary/slips', label: 'Salary Paid Slip', icon: Receipt, dark: 'bg-purple-700', light: 'bg-purple-100', rgb: '126 34 206' },
  { id: 'sheet', path: '/education/salary/sheet', label: 'Salary Sheet', icon: Sheet, dark: 'bg-amber-700', light: 'bg-amber-100', rgb: '180 83 9' },
  { id: 'report', path: '/education/salary/report', label: 'Salary Report', icon: BarChart3, dark: 'bg-teal-700', light: 'bg-teal-100', rgb: '15 118 110' },
];

// ============================ ATTENDANCE (query-based) ============================
export const attendanceTabs: ModuleTab[] = [
  { id: 'students', path: '/education/attendance', label: 'Students Attendance', icon: Users, dark: 'bg-blue-700', light: 'bg-blue-100', rgb: '29 78 216' },
  { id: 'staff', path: '/education/attendance?type=staff', label: 'Employees Attendance', icon: UserCheck, dark: 'bg-emerald-700', light: 'bg-emerald-100', rgb: '4 120 87' },
  { id: 'class-report', path: '/education/attendance?tab=class-report', label: 'Class wise Report', icon: CalendarDays, dark: 'bg-purple-700', light: 'bg-purple-100', rgb: '126 34 206' },
  { id: 'student-report', path: '/education/attendance?tab=student-report', label: 'Students Attendance Report', icon: ClipboardList, dark: 'bg-amber-700', light: 'bg-amber-100', rgb: '180 83 9' },
  { id: 'staff-report', path: '/education/attendance?tab=staff-report', label: 'Employees Attendance Report', icon: UserCheck, dark: 'bg-teal-700', light: 'bg-teal-100', rgb: '15 118 110' },
];
...
export const examTabs: ModuleTab[] = [
  ...
  // Exams
  { id: 'create-exam', path: '/education/exams', label: 'New Exam', icon: Edit, dark: 'bg-purple-700', light: 'bg-purple-100', rgb: '126 34 206' },
