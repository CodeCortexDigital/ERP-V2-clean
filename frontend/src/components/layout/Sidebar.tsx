...
export function Sidebar({ isMobile = false, onClose }: { isMobile?: boolean; onClose?: () => void }) {
  ...
  // Master Menu Configuration matching My School light sidebar reference exact design
  const adminMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { label: 'All Classes', href: '/education/academics' },
        { label: 'New Class', href: '/education/academics?action=new-class' }
      ]
    },
    {
      id: 'subjects',
      ...
      subItems: [
        { label: 'Classes With Subjects', href: '/education/curriculum' },
        { label: 'Assign Subjects', href: '/education/curriculum?action=assign' }
      ]
    },
    {
      id: 'students',
      ...
      subItems: [
        ...
        { label: 'Add New', href: '/education/students?action=new' },
    ...
    },
    {
      ...
      subItems: [
        ...
        { label: 'Add New', href: '/education/teachers?action=new' },
    ...
    },
    {
      id: 'fees',
      label: 'Fees',
      icon: <Banknote className="w-4 h-4 text-slate-600" />,
      subItems: [
    ...
    // ============================================================
    // FIXED: SALARY SECTION WITH GENERATE SALARY
    // ============================================================
    {
      id: 'salary',
      label: 'Salary',
      icon: <DollarSign className="w-4 h-4 text-slate-600" />,  // Changed to DollarSign
      subItems: [
        { label: 'Generate Salary', href: '/education/salary/generate' },  // ← NEW
        { label: 'Pay Salary', href: '/education/salary/pay' },
        { label: 'Salary Paid Slip', href: '/education/salary/paid-slip' },
    ...
    // ============================================================
    {
      id: 'attendance',
      label: 'Attendance',
      icon: <Hand className="w-4 h-4 text-slate-600" />,
      subItems: [
    ...
    },
    {
      id: 'whatsapp',
      label: 'WhatsApp',
      icon: <MessageSquare className="w-4 h-4 text-slate-600" />,
    ...
    },
    {
      ...
      icon: <FileQuestion className="w-4 h-4 text-slate-600" />,
      subItems: [
  ...
  const teacherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      label: 'My Timetable',
      icon: <Calendar className="w-4 h-4 text-slate-600" />,
      href: '/education/timetable/view?teacher_id=' + (user?.id || 't-1')
    },
    {
      id: 'behaviour',
      label: 'Behaviour & Skills',
    ...
    },
    {
      ...
      icon: <FileQuestion className="w-4 h-4 text-slate-600" />,
      subItems: [
        { label: 'Chapter Questions', href: '/education/question-bank' }
      ]
    },
    {
      id: 'exams',
    ...
    },
    {
      id: 'logout',
      label: 'Logout',
      icon: <LogOut className="w-4 h-4 text-slate-600" />,
      href: '#logout',
      isLogout: true
    }
  ];
  ...
  const studentMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      icon: <FileText className="w-4 h-4 text-slate-600" />,
      href: `/education/students/admission-letter?student_id=${user?.id || 'std-1'}`
    },
    {
      id: 'paid_fee_receipt',
      label: 'Paid Fee Receipt',
      icon: <CreditCard className="w-4 h-4 text-slate-600" />,
      href: `/education/finance/fees-paid-slip?student_id=${user?.id || 'std-1'}`
    },
    {
      id: 'timetable',
      label: 'My Timetable',
    ...
    },
    {
      ...
      icon: <Award className="w-4 h-4 text-slate-600" />,
      href: `/education/analytics?report=card&student_id=${user?.id || 'std-1'}`
    },
    {
      id: 'test_results',
      label: 'Test Results',
      icon: <Edit className="w-4 h-4 text-slate-600" />,
      href: `/education/class-tests?tab=results&student_id=${user?.id || 'std-1'}`
    },
    {
      id: 'exam_result',
      label: 'Exam Result',
      icon: <Award className="w-4 h-4 text-slate-600" />,
      href: `/education/exams?tab=results&student_id=${user?.id || 'std-1'}`
    },
    {
      id: 'home_assignments',
  ...
  useEffect(() => {
    menuItems.forEach(item => {
      if (item.subItems) {
        const hasActiveChild = item.subItems.some(sub => location.pathname === sub.href || location.pathname.startsWith(sub.href));
        if (hasActiveChild) {
  ...
  const isLinkActive = (href: string) => {
    ...
    try {
      ...
      const hrefUrl = new URL(href, origin);
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isDarkSidebar ? 'text-slate-300 hover:bg-slate-800 hover:text-white' : 'text-slate-700 hover:bg-slate-50 hover:text-slate-950'}
            ...
            <div key={item.id} className="space-y-0.5">
              ...
              <button
                ...
                className={`
                  ...
                  ${hasActiveSub 
                    ? isDarkSidebar ? 'text-white' : 'text-blue-600' 
              ...
              {/* Nested Sub-Menu Items with Vertical Blue Guide Line */}
