...
export default function CursorFollower() {
  ...
  return (
    <>
      ...
      <div
        ref={circleRef}
        className={`pointer-events-none fixed top-0 left-0 z-[9999] rounded-full border-2 border-blue-400 bg-blue-500/10 shadow-[0_0_20px_rgba(59,130,246,0.6)] transition-all duration-300 ease-out ${
          isHovered ? 'w-14 h-14 border-purple-400 bg-purple-500/20 scale-125 shadow-[0_0_30px_rgba(168,85,247,0.8)]' : 'w-10 h-10'
        }`}
        style={{
      ...
      <div
        ref={dotRef}
        className="pointer-events-none fixed top-0 left-0 z-[10000] w-2.5 h-2.5 rounded-full bg-blue-400 shadow-[0_0_12px_#60a5fa]"
        style={{
          willChange: 'transform',
        }}
      />
