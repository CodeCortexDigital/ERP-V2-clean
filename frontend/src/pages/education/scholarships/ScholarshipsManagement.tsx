          ...
          <tbody>
            {scholarships.map(s => (
              <tr key={s.id} className="border-t hover:bg-gray-50">
                ...
                <td className="px-4 py-3 font-mono text-green-600">${s.amount.toLocaleString()}</td>
                <td className="px-4 py-3">{s.deadline}</td>
                <td className="px-4 py-3 text-sm">{s.eligibility}</td>
                <td className="px-4 py-3">{s.applicants}</td>
                <td className="px-4 py-3">{s.awarded}</td>
                ...
                <td className="px-4 py-3">
                  <div className="flex gap-2">
                    ...
                    <button className="text-green-600"><Edit className="h-4 w-4" /></button>
                  </div>
                </td>
              </tr>
            ))}
