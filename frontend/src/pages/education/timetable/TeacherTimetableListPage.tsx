...
import { ArrowLeft, Search, Eye, Edit, Calendar, Users } from 'lucide-react';
...
export default function TeacherTimetableListPage() {
  ...
  const teacherSchedules = useMemo(() => {
    ...
    const active = [...combined, ...customTeachers];
  ...
  const filteredSchedules = useMemo(() => {
    ...
    return teacherSchedules.filter(t => t.name.toLowerCase().includes(term) || t.code.toLowerCase().includes(term));
