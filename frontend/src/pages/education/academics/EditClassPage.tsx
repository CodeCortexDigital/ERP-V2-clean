...
export default function EditClassPage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const [yearsRes, teachersRes, classroomsRes, classData] = await Promise.all([
      ...
      if (classData) {
        setFormData({
          ...
          max_students: Number(classData.max_students) || 30,
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1.5">
              ...
              {errors.teacher_name && <p className="text-xs text-red-500 mt-1">{errors.teacher_name}</p>}
              {teachers.length === 0 && (
            ...
            <div className="space-y-1.5">
              ...
              {errors.classroom && <p className="text-xs text-red-500 mt-1">{errors.classroom}</p>}
              {classrooms.length === 0 && (
                <p className="text-xs text-amber-500 mt-1">
            ...
            <div className="space-y-1.5">
              ...
              />
              {errors.max_students && <p className="text-xs text-red-500 mt-1">{errors.max_students}</p>}
