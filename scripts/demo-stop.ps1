# Stops the local demo started by demo.bat: backend on 8009, frontend on 5179.
# Other dev servers (e.g. on 8000 / 5173) are left alone.
$ErrorActionPreference = 'SilentlyContinue'
$stopped = 0

# 1. Whatever is listening on the demo ports.
foreach ($port in 8009, 5179) {
...
Get-CimInstance Win32_Process |
    Where-Object { $_.CommandLine -match 'runserver 0\.0\.0\.0:8009|vite(\.js"?)? --port 5179|ERP (backend|frontend) \(port' } |
